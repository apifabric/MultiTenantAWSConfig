...
@Component({
  selector: 'SecurityIncident-home',
  templateUrl: './SecurityIncident-home.component.html',
  styleUrls: ['./SecurityIncident-home.component.scss']
})
export class SecurityIncidentHomeComponent implements AfterViewInit {
