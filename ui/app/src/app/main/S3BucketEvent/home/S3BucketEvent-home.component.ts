...
@Component({
  selector: 'S3BucketEvent-home',
  templateUrl: './S3BucketEvent-home.component.html',
  styleUrls: ['./S3BucketEvent-home.component.scss']
})
export class S3BucketEventHomeComponent implements AfterViewInit {
