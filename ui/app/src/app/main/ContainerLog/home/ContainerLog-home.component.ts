...
@Component({
  selector: 'ContainerLog-home',
  templateUrl: './ContainerLog-home.component.html',
  styleUrls: ['./ContainerLog-home.component.scss']
})
export class ContainerLogHomeComponent implements AfterViewInit {
