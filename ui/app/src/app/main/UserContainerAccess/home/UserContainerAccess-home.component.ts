...
@Component({
  selector: 'UserContainerAccess-home',
  templateUrl: './UserContainerAccess-home.component.html',
  styleUrls: ['./UserContainerAccess-home.component.scss']
})
export class UserContainerAccessHomeComponent implements AfterViewInit {
