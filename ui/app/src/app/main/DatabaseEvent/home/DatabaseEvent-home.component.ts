...
@Component({
  selector: 'DatabaseEvent-home',
  templateUrl: './DatabaseEvent-home.component.html',
  styleUrls: ['./DatabaseEvent-home.component.scss']
})
export class DatabaseEventHomeComponent implements AfterViewInit {
