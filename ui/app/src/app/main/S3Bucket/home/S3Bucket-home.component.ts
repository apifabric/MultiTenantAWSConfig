...
@Component({
  selector: 'S3Bucket-home',
  templateUrl: './S3Bucket-home.component.html',
  styleUrls: ['./S3Bucket-home.component.scss']
})
export class S3BucketHomeComponent implements AfterViewInit {
