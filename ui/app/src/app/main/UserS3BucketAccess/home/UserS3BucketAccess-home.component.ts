...
@Component({
  selector: 'UserS3BucketAccess-home',
  templateUrl: './UserS3BucketAccess-home.component.html',
  styleUrls: ['./UserS3BucketAccess-home.component.scss']
})
export class UserS3BucketAccessHomeComponent implements AfterViewInit {
